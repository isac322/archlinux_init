...
gsettings set org.gnome.gnome-system-monitor cpu-colors "[(0, 'rgb(239,41,41)'), (1, 'rgb(245,121,0)'), (2, 'rgb(237,212,0)'), (3, 'rgb(115,210,22)'), (4, 'rgb(52,101,164)'), (5, 'rgb(173,127,168)'), (6, 'rgb(186,189,182)'), (7, 'rgb(46,52,54)')]"
